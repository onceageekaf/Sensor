      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-start gap-8 mb-8">
          ...
          <div className="flex-1">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Object Recognition and Verification on Portable Devices
            </h1>
            <p className="text-xl text-gray-600 mb-6">
              Non-invasive product authentication using unique surface features without QR codes or holograms
            </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12">
          <div className="p-4 bg-white border border-gray-200 rounded-lg">
            ...
            <p className="font-semibold text-gray-900">University of Geneva</p>
          </div>
          <div className="p-4 bg-white border border-gray-200 rounded-lg">
            <p className="text-sm text-gray-600 mb-1">TRL Status</p>
            <p className="font-semibold text-gray-900">7 - Deployed</p>
          </div>
          <div className="p-4 bg-white border border-gray-200 rounded-lg">
            <p className="text-sm text-gray-600 mb-1">Published</p>
            <p className="font-semibold text-gray-900">CVPR 2018</p>
          </div>
          <div className="p-4 bg-white border border-gray-200 rounded-lg">
            <p className="text-sm text-gray-600 mb-1">Application</p>
            <p className="font-semibold text-gray-900">Product Security</p>
          </div>
        </div>
      </div>
    </section>
