    ...
    <section className="py-20 px-6 bg-gradient-to-r from-violet-600 to-violet-700">
      <div className="max-w-3xl mx-auto text-center text-white">
        ...
        <p className="text-lg md:text-xl mb-8 text-violet-100">
          Licensing and collaboration opportunities for therapeutic protein engineering
        </p>
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-8 text-center">
          ...
          <div>
            ...
            <p className="font-semibold">ACS Cent. Sci., 2018</p>
          </div>
          <div>
            <p className="text-sm text-violet-200 mb-2">Application</p>
            <p className="font-semibold">Protein Engineering</p>
          </div>
        </div>
      </div>
    </section>
