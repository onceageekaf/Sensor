...
export const metadata = {
  title: "Dye-Sensitized Oxygen Sensor | ETH Zurich",
  description: "A high-performance chemiresistive sensor for rapid, selective oxygen detection under visible light.",
}
