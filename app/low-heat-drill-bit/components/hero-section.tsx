...
import { EnzymeIcon } from "@/components/icons/bioicons"

export function HeroSection() {
  return (
    <section className="relative overflow-hidden px-6 py-24 md:py-32 bg-gradient-to-b from-rose-50 to-white">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-start gap-8 mb-8">
          <div className="flex-shrink-0">
            <div className="flex h-16 w-16 items-center justify-center rounded-lg bg-rose-100">
              <EnzymeIcon size={32} color="#e11d48" animated />
            </div>
          </div>
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-600 mb-6">
              Optimized drill bit design minimizing tissue temperature elevation during surgical bone drilling
            </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12">
          ...
          <div className="p-4 bg-white border border-gray-200 rounded-lg">
            ...
            <p className="font-semibold text-gray-900">Ann. Biomed. Eng., 2016</p>
          </div>
          <div className="p-4 bg-white border border-gray-200 rounded-lg">
            <p className="text-sm text-gray-600 mb-1">Focus</p>
            <p className="font-semibold text-gray-900">Bone Drilling</p>
          </div>
        </div>
      </div>
    </section>
