    ...
    <section className="py-20 px-6 bg-gradient-to-r from-emerald-600 to-emerald-700">
      <div className="max-w-3xl mx-auto text-center text-white">
        ...
        <p className="text-lg md:text-xl mb-8 text-emerald-100">
          Explore licensing and partnership opportunities in natural insect repellents
        </p>
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-8 text-center">
          ...
          <div>
            <p className="text-sm text-emerald-200 mb-2">Status</p>
            <p className="font-semibold">Patent Pending</p>
          </div>
          <div>
            <p className="text-sm text-emerald-200 mb-2">Focus</p>
            <p className="font-semibold">Natural Repellents</p>
          </div>
        </div>
      </div>
    </section>
